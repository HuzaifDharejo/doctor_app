...
/// Safety alerts banner for drug interactions and allergy conflicts
class SafetyAlertsBanner extends StatelessWidget {
  ...
  bool get hasAlerts => interactionCount > 0 || allergyCount > 0;
...
/// Small action button for section headers
...
/// Vital display card for prescription screen
...
/// Modern section card for prescription screens
