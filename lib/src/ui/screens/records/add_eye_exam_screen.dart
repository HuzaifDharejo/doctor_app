    ...
    return Form(key: _formKey, child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
      ...
      RecordFormSection(
        ...
        child: Column(children: [
          RecordTextField(controller: _chiefComplaintController, label: 'Chief Complaint', hint: 'e.g., Blurred vision, eye pain', maxLines: 2),
          const SizedBox(height: AppSpacing.md),
      ...
      RecordFormSection(
        ...
        child: Column(children: [
          RecordTextField(controller: _diagnosisController, label: 'Diagnosis', hint: 'e.g., Cataract, Glaucoma', maxLines: 2),
          const SizedBox(height: AppSpacing.md),
          RecordTextField(controller: _treatmentController, label: 'Treatment', hint: 'Medications, surgery plan', maxLines: 3),
          const SizedBox(height: AppSpacing.md),
