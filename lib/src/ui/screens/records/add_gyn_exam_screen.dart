    ...
    return Form(key: _formKey, child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
      ...
      RecordFormSection(
        ...
        child: Column(children: [
          RecordTextField(controller: _chiefComplaintController, label: 'Chief Complaint', hint: 'Reason for visit', maxLines: 2, enableVoice: true, suggestions: chiefComplaintSuggestions),
          const SizedBox(height: AppSpacing.md), 
          ChipSelectorSection(
            title: 'Symptoms',
      ...
      RecordFormSection(
        ...
        child: Column(children: [
          RecordTextField(controller: _abdominalExamController, label: 'Abdominal', hint: 'Soft, non-tender', enableVoice: true, suggestions: examinationFindingsSuggestions),
      ...
      RecordFormSection(
        ...
        child: Column(children: [
          RecordTextField(controller: _diagnosisController, label: 'Diagnosis', hint: 'e.g., PCOS, Fibroids', maxLines: 2, enableVoice: true, suggestions: diagnosisSuggestions),
          const SizedBox(height: AppSpacing.md), RecordTextField(controller: _treatmentController, label: 'Treatment', hint: 'Plan, medications', maxLines: 3, enableVoice: true, suggestions: treatmentSuggestions),
